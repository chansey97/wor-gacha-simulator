...
The game’s pools can share one of the pity systems, which allows for varied pulling strategies. This project aims to evaluate these pools to find the best strategy.
