...
;; run-statistics-4:
;; ==== Count Normal Ancient Summoning, the expected number of pulls to obtain a 5-Stars Hero for (sample-size: 10000). ====
;; average: 49.2505
;; median: 35.0
;; max: 194.0
;; min: 1.0
;; stddev: 44.78417968155719
;; 63.26% of players within [1, 50] pulls obtain a 5-Stars Hero.
;; 23.03% of players within [51, 100] pulls obtain a 5-Stars Hero.
;; 9.05% of players within [101, 150] pulls obtain a 5-Stars Hero.
;; 4.66% of players within [151, 200] pulls obtain a 5-Stars Hero.
;; 0.0% of players through the hard pity of 200 pulls obtain a 5-Stars Hero.

;; run-statistics-4:
;; ==== Count Normal Ancient Summoning, the expected number of pulls to obtain a 5-Stars Hero for the first time (sample-size: 10000). ====
;; average: 53.5911
;; median: 39.0
;; max: 195.0
;; min: 1.0
;; stddev: 48.43470141117833
;; 59.78% of players within [1, 50] pulls obtain a 5-Stars Hero for the first time.
;; 24.39% of players within [51, 100] pulls obtain a 5-Stars Hero for the first time.
;; 9.1% of players within [101, 150] pulls obtain a 5-Stars Hero for the first time.
;; 6.73% of players within [151, 200] pulls obtain a 5-Stars Hero for the first time.
